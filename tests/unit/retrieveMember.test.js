const retrieveMember = require("../../controller/retrieveMember");
...
describe("61834610", () => {
  ...
  it("should retrieve one member by id and send response correctly", async () => {
    ...
    jest
      .spyOn(MemberService, "retrieveOneMember")
      .mockResolvedValueOnce(mMemberRecord);
    ...
    expect(mRes.send).toBeCalledWith({
      member_detail: { id: "1", username: "KF1" },
    });
  });
});
